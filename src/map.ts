    ...
    function mouseOver(this: any, d: any) {
      ...
      if (name == "rate") {
        ...
        svg
          ...
          .text(
            "from a grocery store: " +
              format(d.target.__data__.properties.lalowi10share) +
              "%"
          )
          .append("tspan")
          .attr("font-size", 11)
          ...
          .text(
            "live ≥ 10 miles from a grocery store: " +
              format(d.target.__data__.properties.lahunv10share) +
              "%"
          );
      } else {
        const length = Math.max(
          d.target.__data__.properties.County.length,
          ("percentage" + d.target.__data__.properties.lalowi10share).length
        );
        svg
          .append("rect")
          .attr("id", "textBG")
        ...
        svg
          ...
          .attr("y", d.offsetY + 20)
          .text(
            "percentage " + format(d.target.__data__.properties.lalowi10share)
          );
      }
    }
