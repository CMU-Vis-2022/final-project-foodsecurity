        ...
        function mouseOver(this:any, d:any){
            ...
            if(name == 'rate'){
                ...
                svg.append("text")
                        ...
                        .attr("x",d.offsetX > 800?d.offsetX - 7*length:d.offsetX+35)
                        .attr("y",d.offsetY + 20)
                        .text("Population Density: "+ format((parseInt(d.target.__data__.properties.Pop2010)/d.target.__data__.properties.census_area)) + " people per sq miles")
                        .append("tspan")
                        .attr("font-size",11)
                        .attr("x",d.offsetX > 800?d.offsetX - 7*length:d.offsetX+35)
                        .attr("y",d.offsetY + 40)
                        ...
                        .attr("x",d.offsetX > 800?d.offsetX - 7*length:d.offsetX+35)
                        .attr("y",d.offsetY + 72)
                        .text("from a grocery store: "+ format(d.target.__data__.properties.lalowi10share) +"%")
                        .append("tspan")
                        .attr("font-size",11)
                        .attr("x",d.offsetX > 800?d.offsetX - 7*length:d.offsetX+35)
                        .attr("y",d.offsetY + 90)
                        ...
                        .text("live ≥ 10 miles from a grocery store: "+ format(d.target.__data__.properties.lahunv10share) + "%")
            }
            else{
